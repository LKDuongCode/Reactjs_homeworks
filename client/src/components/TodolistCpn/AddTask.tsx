...
export default function AddTask() {
  ...
  let [timeDisplay, setTimeDisplay] = useState<boolean>(false);
  console.log(check);
  // modal setting
  ...
  //hàm lắng nghe thay đổi của input
  ...
  return (
    <>
      <div className="flex gap-5">
        ...
        />
        <button className="border-none px-5 py-2" onClick={handleAdd}>
          Add a new task
        </button>
      </div>
      <div className="z-[1]">
